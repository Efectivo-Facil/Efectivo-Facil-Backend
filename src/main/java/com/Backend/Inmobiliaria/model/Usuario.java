...
public class Usuario {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY, generator = "id_usu")
	@GenericGenerator(name = "id_usu", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",  parameters = {
            @Parameter(name = "sequence_name", value = "id_usu"),
